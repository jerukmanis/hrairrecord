 ...
 * Page class
 */
class Air2312View extends Air2312
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Air2312View";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "Air2312List"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "Air2312List"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "Air2312List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
