 ...
 * Page class
 */
class Air2311View extends Air2311
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Air2311View";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "Air2311List"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "Air2311List"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "Air2311List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
