 ...
 * Page class
 */
class Air2405View extends Air2405
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Air2405View";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "Air2405List"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "Air2405List"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "Air2405List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
