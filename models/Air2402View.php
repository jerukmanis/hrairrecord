 ...
 * Page class
 */
class Air2402View extends Air2402
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Air2402View";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "Air2402List"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "Air2402List"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "Air2402List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
