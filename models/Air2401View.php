 ...
 * Page class
 */
class Air2401View extends Air2401
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Air2401View";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "Air2401List"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "Air2401List"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "Air2401List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
