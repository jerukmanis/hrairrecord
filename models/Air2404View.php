 ...
 * Page class
 */
class Air2404View extends Air2404
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Air2404View";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "Air2404List"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "Air2404List"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "Air2404List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
