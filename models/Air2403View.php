 ...
 * Page class
 */
class Air2403View extends Air2403
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Air2403View";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "Air2403List"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "Air2403List"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "Air2403List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
