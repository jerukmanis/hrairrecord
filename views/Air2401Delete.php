...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fair2401delete = new ew.Form("fair2401delete", "delete");
    currentPageID = ew.PAGE_ID = "delete";
    currentForm = fair2401delete;
    loadjs.done("fair2401delete");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fair2401delete" id="fair2401delete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
        <th class="<?= $Page->id->headerCellClass() ?>"><span id="elh_air2401_id" class="air2401_id"><?= $Page->id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->bulan->Visible) { // bulan ?>
        <th class="<?= $Page->bulan->headerCellClass() ?>"><span id="elh_air2401_bulan" class="air2401_bulan"><?= $Page->bulan->caption() ?></span></th>
<?php } ?>
<?php if ($Page->unit->Visible) { // unit ?>
        <th class="<?= $Page->unit->headerCellClass() ?>"><span id="elh_air2401_unit" class="air2401_unit"><?= $Page->unit->caption() ?></span></th>
<?php } ?>
<?php if ($Page->meteran_bulansebelumnya->Visible) { // meteran_bulansebelumnya ?>
        <th class="<?= $Page->meteran_bulansebelumnya->headerCellClass() ?>"><span id="elh_air2401_meteran_bulansebelumnya" class="air2401_meteran_bulansebelumnya"><?= $Page->meteran_bulansebelumnya->caption() ?></span></th>
<?php } ?>
<?php if ($Page->meteran_bulanini->Visible) { // meteran_bulanini ?>
        <th class="<?= $Page->meteran_bulanini->headerCellClass() ?>"><span id="elh_air2401_meteran_bulanini" class="air2401_meteran_bulanini"><?= $Page->meteran_bulanini->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
