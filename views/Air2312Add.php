...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fair2312add = new ew.Form("fair2312add", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fair2312add;

    // Add fields
    var fields = currentTable.fields;
    fair2312add.addFields([
    ...
    // Form_CustomValidate
    fair2312add.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fair2312add.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fair2312add");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fair2312add" id="fair2312add" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
