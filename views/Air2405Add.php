...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fair2405add = new ew.Form("fair2405add", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fair2405add;

    // Add fields
    var fields = currentTable.fields;
    fair2405add.addFields([
    ...
    // Form_CustomValidate
    fair2405add.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fair2405add.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fair2405add");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fair2405add" id="fair2405add" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
