...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fair2403add = new ew.Form("fair2403add", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fair2403add;

    // Add fields
    var fields = currentTable.fields;
    fair2403add.addFields([
    ...
    // Form_CustomValidate
    fair2403add.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fair2403add.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fair2403add");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fair2403add" id="fair2403add" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
