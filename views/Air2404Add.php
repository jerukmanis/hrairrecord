...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fair2404add = new ew.Form("fair2404add", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fair2404add;

    // Add fields
    var fields = currentTable.fields;
    fair2404add.addFields([
    ...
    // Form_CustomValidate
    fair2404add.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fair2404add.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fair2404add");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fair2404add" id="fair2404add" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
