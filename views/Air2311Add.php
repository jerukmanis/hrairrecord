...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fair2311add = new ew.Form("fair2311add", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fair2311add;

    // Add fields
    var fields = currentTable.fields;
    fair2311add.addFields([
    ...
    // Form_CustomValidate
    fair2311add.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fair2311add.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fair2311add");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fair2311add" id="fair2311add" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
