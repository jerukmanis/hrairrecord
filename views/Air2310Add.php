...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fair2310add = new ew.Form("fair2310add", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fair2310add;

    // Add fields
    var fields = currentTable.fields;
    fair2310add.addFields([
    ...
    // Form_CustomValidate
    fair2310add.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fair2310add.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fair2310add");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fair2310add" id="fair2310add" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
