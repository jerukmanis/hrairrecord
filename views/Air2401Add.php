...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fair2401add = new ew.Form("fair2401add", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fair2401add;

    // Add fields
    var fields = currentTable.fields;
    fair2401add.addFields([
    ...
    // Form_CustomValidate
    fair2401add.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fair2401add.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fair2401add");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fair2401add" id="fair2401add" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
