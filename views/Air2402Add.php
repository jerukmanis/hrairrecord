...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fair2402add = new ew.Form("fair2402add", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fair2402add;

    // Add fields
    var fields = currentTable.fields;
    fair2402add.addFields([
    ...
    // Form_CustomValidate
    fair2402add.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fair2402add.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fair2402add");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fair2402add" id="fair2402add" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
