...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fair2404view = new ew.Form("fair2404view", "view");
    currentPageID = ew.PAGE_ID = "view";
    currentForm = fair2404view;
    loadjs.done("fair2404view");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fair2404view" id="fair2404view" class="ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_air2404_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->bulan->Visible) { // bulan ?>
    <tr id="r_bulan"<?= $Page->bulan->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_air2404_bulan"><?= $Page->bulan->caption() ?></span></td>
...
<?php if ($Page->unit->Visible) { // unit ?>
    <tr id="r_unit"<?= $Page->unit->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_air2404_unit"><?= $Page->unit->caption() ?></span></td>
...
<?php if ($Page->meteran_bulansebelumnya->Visible) { // meteran_bulansebelumnya ?>
    <tr id="r_meteran_bulansebelumnya"<?= $Page->meteran_bulansebelumnya->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_air2404_meteran_bulansebelumnya"><?= $Page->meteran_bulansebelumnya->caption() ?></span></td>
...
<?php if ($Page->meteran_bulanini->Visible) { // meteran_bulanini ?>
    <tr id="r_meteran_bulanini"<?= $Page->meteran_bulanini->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_air2404_meteran_bulanini"><?= $Page->meteran_bulanini->caption() ?></span></td>
...
<?php if ($Page->foto->Visible) { // foto ?>
    <tr id="r_foto"<?= $Page->foto->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_air2404_foto"><?= $Page->foto->caption() ?></span></td>
