...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "HolisRegencyAirRecordAll"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{ADD330E9-F2FD-4275-A779-D0919F6573E6}"); // Project ID
